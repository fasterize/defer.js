...
deferJsNs.DeferJs = function() {
  ...
  Object.defineProperty(this, 'state_', {
    ...
    set: function (newState) {
      window.performance && window.performance.mark && window.performance.mark('Fasterize_deferjs_'
        + deferJsNs.DeferJs.statesStrings[newState]);
...
deferJsNs.DeferJs.statesStrings = [
  'not_started',
  'registered',
  'executing',
  'sync_done',
