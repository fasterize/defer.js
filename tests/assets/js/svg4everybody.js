...
function svg4everybody(rawopts) {
  ...
  var requestAnimationFrame = setTimeout;
  ...
  function oninterval() {
    console.log('oninterval', document.getElementsByTagName('use'));
      ...
      if (svg) {
        ...
        if (LEGACY_SUPPORT && nosvg) {
          ...
          if (!opts.validate || opts.validate(src, svg, use)) {
            ...
            console.log('remove use', use);
            parent.removeChild(use);
            console.log('after removal', document.getElementsByTagName('use'));
...
console.log('before', document.getElementsByTagName('use'));
svg4everybody();
